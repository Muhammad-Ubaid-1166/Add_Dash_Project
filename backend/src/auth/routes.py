...
async def create_user_Account(
    ...
    User is automatically verified upon creation.
    """
    ...
    # AUTOMATICALLY VERIFY THE USER SO THEY DON'T HAVE TO CLICK AN EMAIL LINK
...
# --- REMOVED THE /verify/{token} ENDPOINT COMPLETELY ---
